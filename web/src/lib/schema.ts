...
export const SessionSchema = Schema.Struct({
  ...
  NativeID: optionalNullableString,
  runtimeLabel: optionalNullableString,
  projectionMode: optionalNullableString,
  resumeCommand: optionalNullableString,
  capabilities: Schema.optionalKey(Schema.Record(Schema.String, Schema.Boolean)),
  ...
  ActivityStartedAt: optionalNullableString,
  waitingQuestion: optionalNullableString,
  WaitingQuestion: optionalNullableString,

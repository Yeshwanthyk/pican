...
describe("getComposerElements", () => {
  it("returns the composer runtime elements by stable id", () => {
    ...
    assert(elements.textarea);
    assert(elements.fileInput);
    assert(elements.attachButton);
    assert(elements.attachmentList);
    assert(elements.sendButton);
    assert(elements.cancelButton);
    assert(elements.shell);
    assert(elements.expandButton);

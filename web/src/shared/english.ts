...
export default {
  ...
  "index.schedulesSummary": "Schedules",
  "index.schedulesActiveCount": "{count} active",
  "index.schedulesNone": "No active schedules",
  "index.schedulesNext": "Next: {name} · {when}",
  ...
  "index.noActiveSessions": "Nothing running or waiting",

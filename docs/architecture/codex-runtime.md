...
| View/export/share | Uses the common renderer over an authorized projection. Static export/share remains separate from live chat and SSE. Hosted mode permits local share preview but disables `gh` publication. |
